...
### Dataleveranse basert på SOSI datamodell

**Nivå**: dataset

**Nivåbeskrivelse**: SOSI UML-modell

## Datainnhold og struktur



### Datamodell - Dataleveranse basert på SOSI datamodell



<a href="dataleveranse-basert-pa-sosi-datamodell/dataleveranse-basert-pa-sosi-datamodell_feature_catalogue.png" title="Klikk for stor visning"><img src="dataleveranse-basert-pa-sosi-datamodell/dataleveranse-basert-pa-sosi-datamodell_feature_catalogue.png" alt="Datamodell Dataleveranse basert på SOSI datamodell" style="max-width: 100%; height: auto;" /></a>



➡️ [Se full datamodell for omfang "Dataleveranse basert på SOSI datamodell" (diagram per pakke og objektkatalog)](dataleveranse-basert-pa-sosi-datamodell/objektkatalog.html)
